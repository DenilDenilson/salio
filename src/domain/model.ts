...
export const RuleEvaluationContextSchema = z.object({
  ...
  playerStats: z.record(
    z.object({
      ...
      teamSide: z.enum(["HOME", "AWAY"]).nullable().optional(),
      ...
      shots: z.number().int().nonnegative().nullable().optional(),
...
export const MatchSummarySchema = z.object({
  ...
  sportsEventId: z.string().nullable(),
  sportsProvider: z.enum(["espn", "demo"]).nullable(),
