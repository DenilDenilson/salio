# Prompt para generar el manifiesto de partidos de una fecha específica
...
```text
match-discovery-manifest-FECHA_OBJETIVO.json
```
...
```text
match-discovery-manifest-2026-06-20.json
```
